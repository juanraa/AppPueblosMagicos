...
namespace AppPueblosMagicos
{
    ...
    /// </summary>
    public sealed partial class NewPuebloPage : Page
    {
        public string URLImage;
        public NewPuebloPage()
        {
        ...
        private async void btnGuardar_Click(object sender, RoutedEventArgs e)
        {
            ...
            //var newList = (ObservableCollection<Pueblo>)JsonConvert.DeserializeObject(text, typeof(ObservableCollection<Pueblo>));
            ...
            Pueblo palabra = new Pueblo();
            palabra.Name = txtNombrePueblo.Text;
            palabra.DescripcionEspanish = txtpalespanol.Text;
            palabra.DescripcionFrench = txtDescripcionFrances.Text;
            palabra.Estado = txtEstado.Text;
            palabra.URLImage = URLImage;
            palabra.PuebloID = ListaAGuardar.Count + 1;

            ListaAGuardar.Add(palabra);
            new DashboardViewModel().ListaPueblosMagicosSinMostrar.Add(palabra);
            ...
            try
            {
                ...
                //AppSettings.localSettings.Values["ListaPueblos"] = output;
                //ApplicationData.Current.LocalSettings.Values["ListaPueblos"] = output;
                //LocalStorageHelper.SaveForState(palabra);

                ContentDialog contentDialog = new ContentDialog()
                {
                    Title = "Palabra Agregada",
                    Content = "Se agrego la palabra correctamente",
                    CloseButtonText = "OK"
                };
                await contentDialog.ShowAsync();
            }
